...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C00), 0x80000031u);
...
static void AnalogSetDefault(void)
{
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x000000ACu);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x000000ACu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x00000186u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x000000ECu);
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x00180000u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC2), 0x000000ACu);
